    ...
    <TableHead>
      <TableRow>
        <TableCell padding='checkbox'>
          <Tooltip title='Nuevo'>
            <IconButton component={Link} to='/Plan/CrearPlan'>
              <AddIcon />
            </IconButton>
          </Tooltip>
        </TableCell>
      ...
      {numSelected > 0
        ? (<>
          ...
          <Tooltip title='Actualizar'>
            <IconButton component='a' href={`/Plan/ActualizarPlan/`+idSelected}>
              <EditIcon key={idSelected} />
            </IconButton>
          </Tooltip>
          <Tooltip title='Ver Info'>
            <IconButton component='a' href ={`DetallePlan/`+idSelected} >
...
export default function TablaHistorialPlanes () {
